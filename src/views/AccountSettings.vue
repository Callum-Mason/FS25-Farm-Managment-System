<template>
  <div class="py-8">
      ...
      <div class="space-y-4">
        <div>
          ...
          <input
            ...
            disabled
            class="w-full px-4 py-2 border-2 border-primary/20 rounded-lg bg-gray-100 text-text/60"
          />
        </div>
    ...
    <!-- Danger Zone -->
    <div class="bg-red-50 border-2 border-red-200 rounded-card p-6">
      <h3 class="text-xl font-bold text-red-700 mb-4">Danger Zone</h3>
      
      <div class="space-y-4">
        <div>
          <p class="font-medium text-red-800 mb-2">Delete Your Account</p>
          <div class="bg-white dark:bg-gray-800 border-2 border-red-300 dark:border-red-800 rounded-lg p-4 mb-4">
    ...
    >
      <div class="bg-white dark:bg-gray-800 rounded-card p-6 max-w-md w-full">
        ...
        <div class="space-y-3">
          <button
            ...
            :disabled="isDeleting"
            class="w-full px-6 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition font-medium disabled:opacity-50"
          >
          ...
          <button
            ...
            :disabled="isDeleting"
            class="w-full px-6 py-3 bg-gray-200 text-text rounded-lg hover:bg-gray-300 transition font-medium disabled:opacity-50"
          >
            Cancel
          </button>
        </div>

        <p v-if="deleteError" class="mt-4 text-red-600 text-sm">
          {{ deleteError }}
        </p>
      </div>
    </div>
